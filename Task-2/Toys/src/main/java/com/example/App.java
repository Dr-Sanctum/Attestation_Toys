 ...
 * 
 * К написанию программы можно подойти более творчески и делать так, как Вы
 * поняли задание.
...
public class App {
    public static void main(String[] args) {
        LotsOfToys newLot = new LotsOfToys();
        {
            newLot.addNewToy(1, "Мишка", 5, 50);
            newLot.addNewToy(2, "Мышка", 5, 10);
            newLot.addNewToy(3, "Кошка", 5, 30);
        }
        Viever newViever = new Viever();
        Presenter newPresenter = new Presenter(newLot, newViever);
        newPresenter.Run();
